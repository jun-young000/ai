...
결정트리를 가장 단순하게 표현하자면, Tree 구조를 가진 알고리즘
 ...
 많이 활용되고 있음.-결론 실제로는 안쓰는데 Forest 앙상블 알고리즘의 기본 기반이니 알아둬라.
...
과대적합되는 경향이 있다. 이는 가지치기 기법을 사용해도 크게 개선되지 않는다.
